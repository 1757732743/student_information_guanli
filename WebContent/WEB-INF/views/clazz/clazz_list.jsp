	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
 		       ...
 		       {field:'gradeId',title:'所属专业',width:150, sortable: true,
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		...
	    		<tr >
	    			<td>所属专业:</td>
	    			<td>
	    				<select id="add_gradeId"  class="easyui-combobox" style="width: 200px;" name="gradeId" data-options="required:true, missingMessage:'请选择所属专业'">
	    					<c:forEach items="${ gradeList}" var="grade">
	    						<option value="${grade.id }">${grade.name }</option>
	    					</c:forEach>
	    				</select>
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		...
	    		<tr >
	    			<td>所属专业:</td>
	    			<td>
	    				<select id="edit_gradeId"  class="easyui-combobox" style="width: 200px;" name="gradeId" data-options="required:true, missingMessage:'请选择所属专业'">
	    					<c:forEach items="${ gradeList}" var="grade">
	    						<option value="${grade.id }">${grade.name }</option>
	    					</c:forEach>
	    				</select>
